                ...
                <div class="mt-4">
                    <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                        ...
                        <a class="text-gray-500 cursor-pointer hover:text-gray-700"
                           href="https://www.facebook.com/cougars">
                        ...
                        <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700"
                           href="https://twitter.com/cougars">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                 class="w-5 h-5" viewBox="0 0 24 24">
                                <path
                        ...
                        {{-- Instagram --}}
                        <a class="ml-3 text-gray-500 cursor-pointer hover:text-gray-700"
                           href="https://www.instagram.com/cougars/">
                        ...
                        <ul>
                            <li class="mt-3">
                                <a class="text-gray-500 cursor-pointer hover:text-gray-900"
                                   href="{{ route('safeguarding') }}">Safeguarding</a>
                            </li>
                            <li class="mt-3">
                                <a class="text-gray-500 cursor-pointer hover:text-gray-900"
                                   href="{{ route('code-of-conduct') }}">Code of Conduct</a>
                            </li>
                            <li class="mt-3">
                                <a class="text-gray-500 cursor-pointer hover:text-gray-900"
